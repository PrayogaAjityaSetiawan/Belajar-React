...
const CardProduct = (props) => {
    ...
    return (
        <div className="flex flex-col justify-between font-primary w-[170px]  md:w-[220px] border border-black rounded-xl">
            {children}
        </div>
    )
}
    ...
    return (
        <div className="px-2 md:px-5 pb-2 md:pb-5">
            <a href="" className="flex items-center justify-between">
                ...
                <span className="text-xs md:text-sm text-black font-semibold tracking-tight">${price}</span>
            </a>
